package com.flight.schedule.demo.common.handler;
...
import com.flight.schedule.demo.common.response.ApiResult;
        ...
        if (methodParameter.getContainingClass().isAnnotationPresent(RestController.class)) {
            if (!methodParameter.getMethod().isAnnotationPresent(IgnoreResponseBinding.class)) {
                if (!(body instanceof ApiResponse)) {
                    return new ApiResponse(HttpStatus.OK,"success", ApiResult.builder().payload(body).build(), null);
                }
            }
        }
        return body;
